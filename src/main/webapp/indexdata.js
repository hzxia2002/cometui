...
[
	...
	{ text: '下拉框',isexpand:false, children: [  
		...
		{url:"demos/comboBox/comboBoxCascade.html",text:"联动效果(<font color='red'>New</font>)"},
	...
	{ text: '树',isexpand:false, children: [  
		...
		{url:"demos/tree/case/twotree.htm",text:"两颗树 可拖拽"},
	...
	{ text: '表单', isexpand: false, children: [
        ...
        {url:"demos/form/fieldSet.html",text:"综合表单(<font color='red'>New</font>)"},
        {url:"demos/form/numberbox.htm",text:"数字框(<font color='red'>New</font>)"},
	...
	{ isexpand: "false", text: "表格", children: [
	    ...
	    {isexpand:"false",text:"编辑表格(<font color='red'>New</font>)",children:[
		    {url:"demos/grid/editgrid/addrow.htm",text:"编辑支持(<font color='red'>New</font>)"},
		    {url:"demos/grid/editgrid/cascade.html",text:"级联下拉编辑(<font color='red'>New</font>)"},
		    ...
		    {url:"demos/grid/editgrid/getdata.htm",text:"获取更新数据(<font color='red'>New</font>)"}
	    ]},
	    ...
	    {isexpand:"false",text:"表头/列(<font color='red'>New</font>)",children:[
		    ...
		    {url:"demos/grid/mulheader/grid1.htm",text:"多表头1(<font color='red'>New</font>)"},
	    ...
	    {isexpand:"false",text:"分组(<font color='red'>New</font>)",children:[
		    { url: "demos/grid/groupable/default.htm", text: "默认" },
            { url: "demos/grid/groupable/render.htm", text: "自定义格式(<font color='red'>New</font>)" },
        ...
        {isexpand:"false",text:"大数据",children:[
            {url:"demos/grid/bigdata/data100.htm",text:"100条"},
            {url:"demos/grid/bigdata/data200.htm",text:"200条"},
            {url:"demos/grid/bigdata/data300.htm",text:"300条"},
            {url:"demos/grid/bigdata/data500.htm",text:"500条"},
            {url:"demos/grid/bigdata/data1000.htm",text:"1000条"}
        ]}
    ]},
    ...
    {isexpand:"false",text:"面板",children:[ 
	    ...
	    {url:"demos/accordion/panel.html",text:"面板(<font color='red'>New</font>)"}
    ]},
