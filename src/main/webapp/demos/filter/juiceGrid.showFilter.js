//扩展 juiceGrid 的 搜索功能(高级自定义查询).应用: demos/filter/grid.htm
$.jui.controls.Grid.prototype.showFilter = function ()
{
    ...
    var filter = filtercontainer.juiceFilter({ fields: getFields() });
    return g.winfilter = $.juiceDialog.open({
