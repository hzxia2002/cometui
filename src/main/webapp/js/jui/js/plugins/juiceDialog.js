            ...
            if (p.buttons)
            {
                ...
                $(p.buttons).each(function (i, item)
                {
                    ...
                    if(item.css && typeof item.css=='string'){
                        btn = $('<div class="l-dialog-btn"><div class="l-dialog-btn-l"></div><div class="l-dialog-btn-r"></div><div class="l-dialog-btn-inner ' + item.css + '"></div></div>');
                    }
                    else{
                    ...
                    if(item.icon){
                        $(".l-dialog-btn-inner", btn).html("<div class='l-icon " + item.icon + "'></div><span>" + item.text + "</span>");
                    }
                    else{
                        $(".l-dialog-btn-inner", btn).html("<span>" + item.text + "</span>");
                    }
