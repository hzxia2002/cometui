...
(function ($)
{
    ...
    $.juiceDefaults.Button = { width: 100, text: 'Button', disabled: false };
...
(function ($)
{
    ...
    $.juiceDefaults.CheckBox = { disabled: false };
...
(function ($)
{
    ...
    $.juiceDefaults.ComboBox = {
        ...
        split: ";",
        data: null,
        tree: null,            //下拉框以树的形式显示，tree的参数跟juiceTree的参数一致 
...
(function ($)
{
    ...
    //dialog 图片文件夹的路径 预加载
    $.jui.DialogImagePath = "../../lib/jui/skins/Aqua/images/win/";
...
(function ($)
{
    ...
    $.juiceDefaults.Form.editorBulider = function (jinput)
    {
        //这里this就是form的jui对象
        var g = this, p = this.options;
        var inputOptions = {};
        ...
        if (jinput.is("select"))
        {
            jinput.juiceComboBox(inputOptions);
        }
        else if (jinput.is(":text") || jinput.is(":password"))
        {
            ...
            switch (ltype)
            {
                ...
                case "combobox":
                    ...
                    break;
                case "spinner":
                    jinput.juiceSpinner(inputOptions);
                    break;
                case "date":
                    jinput.juiceDateEditor(inputOptions);
                    break;
                case "float":
                case "number":
                    inputOptions.number = true;
                    jinput.juiceTextBox(inputOptions);
                    break;
                case "int":
                case "digits":
        ...
        {
            jinput.juiceRadio(inputOptions);
        }
        else if (jinput.is(":checkbox"))
        {
            jinput.juiceCheckBox(inputOptions);
        }
    ...
    $.jui.controls.Form.juiceExtend($.jui.core.UIComponent, {
        ...
        _buliderControl: function (field)
        {
            ...
            out.push(" jui='" + p.toJSON(fieldOptions) + "' ");
            //验证参数
            if (field.validate)
            {
...
(function ($)
{
    ...
    $.juiceDefaults.Grid = {
        ...
        switchPageSizeApplyComboBox: false,     //切换每页记录数是否应用juiceComboBox
        ...
        toolbar: null,                           //工具条,参数同 juiceToolbar的
    ...
    $.jui.controls.Grid.juiceExtend($.jui.core.UIComponent, {
        ...
        */
        ...
        _onClick: function (e)
        {
            ...
            if (src.out)
            {
                if (g.editor.editing && !$.jui.win.masking) g.endEdit();
